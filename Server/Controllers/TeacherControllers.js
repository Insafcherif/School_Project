...
const deleteTeacher = async (req, res) => {
    ...
    try {
      ...
      const teachers = await Teacher.find();
      res.status(200).json({ msg: "delete is succesfully done", teachers: teachers });
    } catch (error) {
  ...
  const updateteacher = async (req, res) => {
    ...
    try {
      ...
      const teachers = await Teacher.find();
      res.status(200).json({ msg: "update teacher is succesfully", updatedTeacher });
    } catch (error) {
...
module.exports = { getAllTeachers, addTeacher, getOneTeacher, deleteTeacher, updateteacher};
